...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/anaconda-auth-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/anaconda-auth-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add anaconda-auth
# for installing globally
pixi global install anaconda-auth
```
...
It is possible to list all of the versions of `anaconda-auth` available on your platform:
...
```
pixi search anaconda-auth --channel conda-forge
```
